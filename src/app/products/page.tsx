...
const Products = () => {
  ...
  return (
    <div className="mx-auto pb-5 w-full">
      {/* Search Bar */}
      <div className="mb-6">
        <div className="flex items-center border-2 border-gray-200 rounded bg-white">
          ...
          products?.map((product) => (
            ...
            >
              <div className="flex flex-col items-center">
                <Image
                  src={`https://s3-inventory-mgt.s3.us-east-2.amazonaws.com/product${Math.floor(Math.random() * 3) + 1}.png`}

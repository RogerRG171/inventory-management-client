...
const StatCard = ({
  ...
  return (
    <div className="flex flex-col justify-between md:row-span-1 xl:row-span-2 col-span-1 bg-white shadow-md rounded-2xl pb-3">
      {/* Header */}
      <div>
      ...
      {/* Body */}
      <div className="grid grid-cols-4 grid-rows-2 text-center gap-4 mt-4 md:pr-7 pr-2">
